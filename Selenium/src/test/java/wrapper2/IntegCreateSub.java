...
import wrapper2.ParaDataWrapper;

public class IntegCreateSub extends ParaDataWrapper {

		
	    @Test(dataProvider = "getData")
			
	        public void integdataTest(String cName, String fName, String lName, String lcName) {	
					//click crm/sfa
